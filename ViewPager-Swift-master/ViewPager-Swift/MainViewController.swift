...
class MainViewController: UIViewController {
    ...
    let tabs1 = [
        ViewPagerTab(title: "       ", image: UIImage(named: "apple")),
        ViewPagerTab(title: "Following", image: UIImage(named: "carrot")),
        ViewPagerTab(title: "Trending", image: UIImage(named: "apple")),
        ViewPagerTab(title: "       ", image: UIImage(named: "carrot")),
